...
class CanvAscii {
  constructor(
    { text, asciiFontSize, textFontSize, textColor, planeBaseHeight, enableWaves, waveIntensity, waveSpeed },
    containerElem,
    width,
    height
  ) {
...
export default function ASCIIText({
  ...
  planeBaseHeight = 8,
  enableWaves = true,
  waveIntensity = 1.0,  // New parameter: 0.0 = no waves, 1.0 = normal, >1.0 = more intense
  waveSpeed = 5.0,
}) {
