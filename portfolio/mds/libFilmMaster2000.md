...
![Reverse function](assets/libFilmMaster2000/REVERSED-M.gif)

### Channel Swap
Swaps the values between two target channels

![Swap function](assets/libFilmMaster2000/SWAPPED-M.gif)

### Channel Clip
Clips the values of a channel to the given range

![Clip function](assets/libFilmMaster2000/CLIPPED-M.gif)

# Channel Scale
Scales the values of a channel by the factor

![Scale function](assets/libFilmMaster2000/SCALED-M.gif)
...
![Slow motion function](assets/libFilmMaster2000/SLOWED-M.gif)

### Trim
Trims the video to a given range of frames

![Trim function](assets/libFilmMaster2000/TRIMMED-M.gif)

### Join
Concatenates two input videos (original joined to reversed in the example)

![Join function](assets/libFilmMaster2000/JOINED-M.gif)
